...
function expandSideContent(){
	if(expanded) {
		$("#third-column").removeClass("col-sm-8");
		$("#second-column").addClass("col-sm-4");
		$("#third-column").addClass("col-sm-4");
		$("#second-column").append('<div id="main-content"></div>');
		loadContent(currentContent);
		expanded=false;
	} else {
		$("#second-column").empty();
		$("#second-column").removeClass("col-sm-4");
		$("#third-column").removeClass("col-sm-4");
		$("#third-column").addClass("col-sm-8");
		expanded=true;
	}
}
